...
export default function ContactAndMap() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-20 bg-[#faf9f6] border-t border-[#c5c6cf]/30 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Left Column: Contact Form (Slides in from Left) */}
          <div
            style={{ transitionDelay: isVisible ? "150ms" : "0ms" }}
            className={`lg:col-span-6 bg-white rounded-3xl p-6 sm:p-8 lg:p-10 border border-[#c5c6cf]/40 shadow-xl hover:shadow-2xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col justify-between ${
          ...
          >
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 p-4 rounded-2xl bg-[#f8f9ff] border border-[#c5c6cf]/30 text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <a href={`tel:${CHURCH_INFO.hotlines[0]}`} className="font-bold text-[#000922] hover:text-[#904d00] transition-colors">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${CHURCH_INFO.email}`} className="font-bold text-[#000922] hover:text-[#904d00] transition-colors">
                      {CHURCH_INFO.email}
                    </a>
                  </div>
                </div>
              ...
              {submitted ? (
                <div className="p-8 rounded-2xl bg-[#e5eeff] border border-[#f59e0b]/40 text-center my-4 animate-fade-in">
                  <div className="w-14 h-14 rounded-full bg-[#f59e0b] text-[#070d1a] flex items-center justify-center mx-auto mb-4 shadow-md">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-[#000922] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#904d00] transition-colors shadow cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        className="w-full rounded-xl bg-[#f1f5f9] border border-[#c5c6cf]/60 px-3.5 py-2.5 text-sm text-[#0b1c30] focus:outline-none focus:ring-2 focus:ring-[#f59e0b] transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      className="w-full rounded-xl bg-[#f1f5f9] border border-[#c5c6cf]/60 px-3.5 py-2.5 text-sm text-[#0b1c30] focus:outline-none focus:ring-2 focus:ring-[#f59e0b] resize-none transition-all"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-6 rounded-xl bg-[#000922] hover:bg-[#904d00] text-white font-headline text-xs font-bold uppercase tracking-wider transition-all shadow-md active:scale-98 flex items-center justify-center gap-2 cursor-pointer hover:shadow-lg"
                  >
          ...
          {/* Right Column: Interactive Google Map (Slides in from Right) */}
          <div
          ...
          >
            <div className="flex flex-col h-full justify-between">
              ...
              <a
                ...
                className="w-full py-3 px-6 rounded-xl bg-[#904d00] hover:bg-[#000922] text-white font-headline text-xs font-bold uppercase tracking-wider transition-all shadow-md active:scale-98 flex items-center justify-center gap-2 cursor-pointer hover:shadow-lg"
              >
